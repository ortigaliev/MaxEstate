...
const uploader_estate = require("./utils/upload-multer")("estate");
...
router_bssr
  ...
  .post(
    "/signup",
    uploader_members.single("agency_img"),
    agencyController.signupProcess
  ); //signup router
...
router_bssr.post(
  ...
  uploader_estate.array("estate_images", 5),
  estateController.addNewEstate
);
router_bssr.post(
  "/estate/edit/:id",
  agencyController.validateAuthAgency,
  estateController.updateChosenEstate
);
